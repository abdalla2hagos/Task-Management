                ...
                <form className='grid'>
                    ...
                    <div>
                        ...
                        <div className='flex--flow'>
                            <input className='fs--0-875 addSubtask' type='text' name='addSubtask' placeholder='e.g. Make coffe'/>
                        ...
                        <div className='flex--flow'>
                            <input className='fs--0-875 addSubtask' type='text' name='addSubtask' placeholder='e.g. Drink coffee & smile'/>
                            <button className='removeItemIcon'>
                                <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg"><g fill="#828FA3" fill-rule="evenodd"><path d="m12.728 0 2.122 2.122L2.122 14.85 0 12.728z"/><path d="M0 2.122 2.122 0 14.85 12.728l-2.122 2.122z"/></g></svg>
                            </button>
                        </div>

                        <button className='light--Button purpleText--1 grayBackground--3 fw--bold subtaskBtn'>
